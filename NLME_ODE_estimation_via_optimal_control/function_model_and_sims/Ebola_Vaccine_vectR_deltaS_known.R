Ebola_Vaccine_model_vectR_deltaS_known<- function(t,param_sub,param_pop,exo_par)
{
  
  log_delta_S = exo_par[[1]]
  ...
  phi_S = exp(param_pop[1] +param_sub[1] )
  phi_L = exp(param_pop[2] +param_sub[2] )
